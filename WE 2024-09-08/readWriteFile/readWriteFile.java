 ...
 *Description: readWriteFile Class which gets src/input.txt and assigns whats given to the student class. Outputs our txt file to its designation location
 *
 */
import java.io.*;
import java.util.*;
